...
export default function WmsAddressesReportPage() {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    queryFn: async () => {
      ...
      const res = await fetch(`/api/reports/wms-addresses?${params}`, { credentials: "include" });
  ...
  return (
    <div className="min-h-screen bg-background">
      <GradientHeader title="Relatório de Endereços" subtitle="Ocupação e status dos endereços WMS">
