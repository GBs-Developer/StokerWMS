...
export default function PickingListReport() {
    ...
    const handlePickupPointsNext = async () => {
        // Bug 7: Fetch order IDs that have items in selected pickup points
        if (!selectAllPickupPoints && selectedPickupPoints.length > 0) {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    setValidOrderIds(null); // fallback: show all
                    setFilteredCounts({});
                }
            } catch {
                setValidOrderIds(null); // fallback: show all
            ...
            setValidOrderIds(null); // "Todos os pontos" — sem filtro de ID
            setFilteredCounts({});
        }
