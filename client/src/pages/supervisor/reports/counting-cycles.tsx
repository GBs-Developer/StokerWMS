...
export default function CountingCyclesReportPage() {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    queryFn: async () => {
      ...
      const res = await fetch(`/api/reports/counting-cycles?${params}`, { credentials: "include" });
  ...
  return (
    <div className="min-h-screen bg-background">
      <GradientHeader title="Relatório de Contagens" subtitle="Ciclos de contagem e divergências">
